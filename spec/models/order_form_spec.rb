  ...
  describe "商品購入機能" do
    ...
    context "商品の購入ができないとき" do
      ...
      it "郵便番号が8桁未満では購入できない" do
        ...
        @order_form.valid?
        expect(@order_form.errors.full_messages).to include("郵便番号'000-0000'の形式で入力してください")
      end
      ...
      it "電話番号が10桁未満では購入できない" do
        ...
        @order_form.valid?
        expect(@order_form.errors.full_messages).to include("電話番号桁数を確認してください")
      end
      ...
      it "電話番号が全角では購入できない" do
        ...
        @order_form.valid?
        expect(@order_form.errors.full_messages).to include("電話番号半角数字のみで入力してください")
      end
      ...
      it "tokenがnilでは購入できない" do
        ...
        @order_form.valid?
        expect(@order_form.errors.full_messages).to include("お支払い情報を正しく入力してください")
      end
    end
  end
end
